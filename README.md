...
Exercícios_Python_Nicoly_6b_noite.ipynb - lista com 50 exercícios de Python, indo do básico (variáveis, laços, funções) até coisas um pouco mais avançadas, como listas, dicionários, recursão, ordenação de listas e alguns jogos simples.
